...
module.exports = function (context) {
    ...
    var isNegationExpression = _require.isNegationExpression;
    var isEquivalentExp = _require.isEquivalentExp;

    var _require2 = require('../util/lodashUtil');

    var isLodashCallToMethod = _require2.isLodashCallToMethod;
