...
module.exports = function (context) {
    ...
    function reportIfConnectiveOfParamInvocations(node) {
        var retVal = getValueReturnedInFirstLine(node);
    ...
    function reportIfDoubleFilterLiteral(node) {
        if (onlyPassesIdentifier(node) && isObjectOfMethodCall(node) && isCallToConditionMethod(node.parent.parent) && onlyPassesIdentifier(node.parent.parent)) {
